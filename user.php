...
<div class="wrapper">
		<nav>
		<ul>
	<li><a href="user/obat/tampil.php"> Obat </a></li>
    <li><a href="user/pembeli/tampil.php"> Pembeli </a></li>
    <li><a href="user/karyawan/tampil.php"> Karyawan</a></li>
    <li><a href="user/transaksi/tampil.php"> Transaksi</a></li>
